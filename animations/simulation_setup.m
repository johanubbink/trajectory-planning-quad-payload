...
tun_chim_tun__obs_input = load ('../example_trajectories/example2.mat');
...
path_theta_pos_dat= path_theta_pos.Data;


save('expected_trajectory.mat','L','path_theta_pos_dat','path_fx_dat','path_a_dat','path_a_dot_dat','path_x_dot_dat','path_x_pos_dat','path_z_dot_dat','path_z_pos_dat','tout','-v7')
%% Save Stuffs
%run simmulink model
